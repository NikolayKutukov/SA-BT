...
Usage:
    ...
    python scripts/run_nested_cv.py --setups setup_1 setup_2 --models cox_ph rsf
...
from src.benchmark.nested_cv_runner import NestedCVRunner, GENERATORS
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Number of inner CV folds for HP tuning (default: 5)",
    )
    parser.add_argument(
